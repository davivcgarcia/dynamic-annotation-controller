...
KIND_CLUSTER ?= dynamic-annotation-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name dynamic-annotation-controller-builder
	$(CONTAINER_TOOL) buildx use dynamic-annotation-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm dynamic-annotation-controller-builder
	rm Dockerfile.cross
